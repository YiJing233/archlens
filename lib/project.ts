...
export const milestones = [
  ...
  { phase: "M2", status: "当前", title: "MCP 稳定化", summary: "把案例资料变成可被外部 Agent 稳定调用的公共知识入口。", deliverables: ["服务 0.2.0 / schema 1.0.0", "JSON-RPC 错误、限流与请求观测", "公开 Demo Endpoint 与远程 smoke 验证", "Claude / Cursor 远程 HTTP 配置示例"] },
