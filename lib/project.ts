...
export const milestones = [
  ...
  { phase: "M4", status: "进行中", title: "生产级知识基础设施", summary: "在保持开放和可追溯的前提下，接入更多资料来源。", deliverables: ["来源 intake 与可配置抓取边界", "D1 证据登记、审核状态与事件", "D1 限流 bucket 与内存 fallback", "顺序 source:ingest 与失败门禁", "逐案例哈希、数据集版本与变更记录", "可移交 workspace snapshot", "鉴权、配额与团队空间", "可选的用户自有模型工作流"] },
];
